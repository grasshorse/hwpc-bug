 ...
 */
class MobileBasePage extends BasePage_1.default {
    constructor(web) {
        super(web);
        // Mobile-specific selectors
        this.MOBILE_MENU_TOGGLE = Constants_1.default.MOBILE_MENU_BUTTON;
        this.MOBILE_MENU_OVERLAY = Constants_1.default.MOBILE_MENU_OVERLAY;
        this.MOBILE_MENU_CONTAINER = Constants_1.default.MOBILE_NAV_MENU;
        this.MOBILE_BOTTOM_NAV = Constants_1.default.MOBILE_BOTTOM_NAV;
        this.MOBILE_TAB_BAR = Constants_1.default.MOBILE_TAB_BAR;
    }
    ...
    async openMobileMenu() {
        try {
            ...
            const isToggleVisible = await this.web.element(this.MOBILE_MENU_TOGGLE, "Mobile Menu Toggle").isVisible(Constants_1.default.MOBILE_WAIT_TIMEOUT);
            if (isToggleVisible) {
                ...
                await this.page.waitForTimeout(Constants_1.default.MOBILE_MENU_SLIDE_DURATION);
                // Verify menu opened
    ...
    async closeMobileMenu() {
        try {
            ...
            await this.page.waitForTimeout(Constants_1.default.MOBILE_MENU_FADE_DURATION);
     ...
     */
    async navigateViaBottomNav(navItem) {
        try {
     ...
     */
    async navigateViaTabBar(tabName) {
        try {
    ...
    async fillMobileForm(formData) {
        try {
            for (const [fieldName, value] of Object.entries(formData)) {
                ...
                await this.page.waitForTimeout(Constants_1.default.MOBILE_FORM_VALIDATION_DELAY);
            }
     ...
     */
    async submitMobileForm(submitButtonSelector) {
        try {
            ...
            await this.page.waitForTimeout(Constants_1.default.MOBILE_TRANSITION_DELAY);
    ...
    async performMobileSearch(searchTerm) {
        try {
            ...
            const mobileSearchSelector = Constants_1.default.MOBILE_SEARCH_SELECTOR;
     ...
     */
    async interactWithMobileCard(cardIndex, action = 'tap') {
        try {
            const cardSelector = `${Constants_1.default.MOBILE_CARD_CONTAINER}:nth-child(${cardIndex + 1})`;
            switch (action) {
                case 'tap':
    ...
    async pullToRefresh() {
        try {
            const refreshSelector = Constants_1.default.MOBILE_PULL_TO_REFRESH;
    ...
    async triggerInfiniteScroll() {
        try {
            const scrollTriggerSelector = Constants_1.default.MOBILE_INFINITE_SCROLL;
     ...
     */
    async interactWithBottomSheet(action = 'open') {
        try {
            const bottomSheetSelector = Constants_1.default.MOBILE_BOTTOM_SHEET;
            switch (action) {
                case 'open':
     ...
     */
    async selectFromActionSheet(optionText) {
        try {
            const actionSheetSelector = Constants_1.default.MOBILE_ACTION_SHEET;
    ...
    async waitForMobileLoading() {
        try {
            ...
            const mobileLoadingSelector = Constants_1.default.MOBILE_LOADING_SPINNER;
            ...
            const skeletonSelector = Constants_1.default.MOBILE_SKELETON_LOADER;
     ...
     */
    async checkMobileConnectivity() {
        try {
            const offlineIndicatorSelector = Constants_1.default.MOBILE_OFFLINE_INDICATOR;
    ...
    async verifyTouchTargetSizes() {
        try {
            const touchTargetSelector = Constants_1.default.MOBILE_TOUCH_TARGET;
     ...
     */
    async verifyMobileForms() {
        try {
            const mobileFormSelector = Constants_1.default.MOBILE_FORM_CONTAINER;
            ...
            if (isMobileFormVisible) {
                ...
                const floatingLabelSelector = Constants_1.default.MOBILE_FLOATING_LABEL;
     ...
     * Verify mobile content layout
     */
    async verifyMobileContentLayout() {
        try {
            // Check for mobile card layout
            const mobileCardSelector = Constants_1.default.MOBILE_CARD_CONTAINER;
            ...
            const mobileListSelector = Constants_1.default.MOBILE_LIST_ITEM;
...
exports.default = MobileBasePage;
//# sourceMappingURL=MobileBasePage.js.map