...
const MockAuthManager_1 = require("../../support/MockAuthManager");
/**
 ...
 */
(0, cucumber_1.Given)('I am authenticated as MVP user {string}', async function (userEmail) {
    // Initialize mock auth manager for this test context
    this.mockAuth = new MockAuthManager_1.MockAuthManager();
 ...
 * Requirements: 10.1 - MVP mock authentication with usermvp@hwpc.net
 */
(0, cucumber_1.Given)('I am logged in as the MVP test user', async function () {
    // Initialize mock auth manager for this test context
    this.mockAuth = new MockAuthManager_1.MockAuthManager();
    // Ensure page is available from hooks
    if (!this.page) {
 ...
 */
(0, cucumber_1.When)('I verify my authentication status', async function () {
    if (!this.mockAuth) {
 ...
 * Requirements: 10.1 - MVP mock authentication with usermvp@hwpc.net
 */
(0, cucumber_1.Then)('I should be authenticated as {string}', async function (expectedEmail) {
    if (!this.mockAuth) {
        throw new Error('Mock authentication not initialized');
    }
 ...
 */
(0, cucumber_1.Then)('I should have {string} permission', async function (permission) {
    if (!this.mockAuth) {
        throw new Error('Mock authentication not initialized');
    }
 ...
 */
(0, cucumber_1.When)('I navigate to the dashboard', async function () {
    if (!this.page) {
 ...
 * Requirements: 4.6 - Page Object Model with mock authentication integration
 */
(0, cucumber_1.Then)('I should see the main navigation menu', async function () {
    if (!this.page) {
        throw new Error('Page not initialized');
    }
 ...
 * Requirements: 10.1 - MVP mock authentication with usermvp@hwpc.net
 */
(0, cucumber_1.Then)('I should see my user name {string} in the header', async function (expectedUserName) {
    if (!this.page) {
        throw new Error('Page not initialized');
    }
 ...
 * Requirements: 10.1 - MVP mock authentication with appropriate permissions
 */
(0, cucumber_1.Then)('I should have access to all administrative functions', async function () {
    if (!this.page) {
        throw new Error('Page not initialized');
    }
 ...
 */
(0, cucumber_1.When)('I create a new test customer', async function () {
    if (!this.mockAuth) {
        throw new Error('Mock authentication not initialized');
    }
 ...
 * Requirements: 10.3 - Test data attribution and identification
 */
(0, cucumber_1.Then)('the customer should be marked as created by {string}', async function (expectedCreatedBy) {
 ...
 * Requirements: 10.3 - Test data attribution and identification
 */
(0, cucumber_1.Then)('the customer should have the {string} flag set to true', async function (flagName) {
    if (!this.testCustomer) {
        throw new Error('Test customer not created');
    }
 ...
 * Requirements: 10.3 - Test data attribution and identification
 */
(0, cucumber_1.Then)('the customer should be easily identifiable as test data', async function () {
    if (!this.testCustomer) {
        throw new Error('Test customer not created');
    }
    const hasTestIdentifiers = this.testCustomer.mvpTestData === true &&
...
//# sourceMappingURL=MVPAuthSteps.js.map