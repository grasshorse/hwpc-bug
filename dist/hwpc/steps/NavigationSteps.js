...
const NavigationPage_1 = __importDefault(require("../pages/NavigationPage"));
 ...
 */
(0, cucumber_1.Given)('user is on baseurl', async function () {
    try {
        console.log('Navigating to base URL...');
        const navigationPage = new NavigationPage_1.default(this.web);
 ...
 */
(0, cucumber_1.When)('the user clicks {string}', async function (pageName) {
    try {
        console.log(`User clicking on ${pageName} navigation...`);
        const navigationPage = new NavigationPage_1.default(this.web);
        // Validate page name is supported
        const supportedPages = NavigationConstants_1.default.getPageNames();
 ...
 */
(0, cucumber_1.Then)('user should be on {string}', async function (pageName) {
    try {
 ...
 */
(0, cucumber_1.Then)('the navigation interface should be responsive', async function () {
    try {
 ...
 */
(0, cucumber_1.When)('the user navigates to {string} via mobile menu', async function (pageName) {
    try {
 ...
 */
(0, cucumber_1.When)('the user toggles the mobile menu', async function () {
    try {
 ...
 */
(0, cucumber_1.Then)('the mobile menu should be {string}', async function (state) {
    try {
 ...
 */
(0, cucumber_1.When)('the user uses touch navigation to go to {string}', async function (pageName) {
    try {
 ...
 */
(0, cucumber_1.Then)('the page should load within {int} seconds', async function (timeoutSeconds) {
    try {
 ...
 */
(0, cucumber_1.Then)('all navigation links should be accessible', async function () {
    try {
        ...
        const expectedPages = NavigationConstants_1.default.getPageNames();
        ...
        for (const testPage of testPages) {
            try {
                ...
                const baseUrl = NavigationConstants_1.default.getBaseUrl();
 ...
 */
(0, cucumber_1.When)('the user retries navigating to {string}', async function (pageName) {
    try {
 ...
 */
(0, cucumber_1.When)('the user navigates to {string} via direct URL', async function (pageName) {
    try {
 ...
 */
(0, cucumber_1.When)('the user navigates to {string} with smart recovery', async function (pageName) {
    try {
 ...
 */
(0, cucumber_1.Then)('the page should not be in an error state', async function () {
    try {
 ...
 */
(0, cucumber_1.When)('the user attempts error recovery for {string}', async function (pageName) {
    try {
 ...
 */
(0, cucumber_1.Given)('user is on baseurl with {string} viewport', async function (viewportType) {
    try {
        ...
        const timeout = NavigationConstants_1.default.getTimeout(currentViewportCategory, 'pageLoad');
        await this.web.getPage().waitForLoadState('networkidle', { timeout });
        await navigationPage.waitForLoadingComplete();
 ...
 */
(0, cucumber_1.Then)('the navigation should be responsive for current viewport', async function () {
    try {
 ...
 */
(0, cucumber_1.When)('the user navigates to {string} using responsive navigation', async function (pageName) {
    try {
 ...
 */
(0, cucumber_1.Then)('all touch targets should meet minimum size requirements', async function () {
    try {
 ...
 */
(0, cucumber_1.Then)('the navigation should adapt to viewport changes', async function () {
    try {
