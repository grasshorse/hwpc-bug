...
class HWPCConfig {
     ...
     */
    static getMobileDevice(deviceName) {
        const devices = this.MOBILE_DEVICES;
     ...
     */
    static isApiTestingEnabled(environment) {
     ...
     */
    static isMobileFirstEnabled(environment) {
     ...
     */
    static getTimeout(operation, environment) {
...
exports.default = HWPCConfig;
// ===== ENVIRONMENT CONFIGURATIONS =====
HWPCConfig.TEST_CONFIG = {
...
HWPCConfig.RESPONSIVE_TEST_VIEWPORTS = [
...
//# sourceMappingURL=HWPCConfig.js.map